...
//USANDO NPM
var express = require("express"); //se importa con el mismo nombre que utilice para salvar la libreria, el nombre en el package.json
var nunjucks = require("nunjucks"); //es un sistema de templates, los templates permiten generar dinamicamente contenido dentro del html
...
var app = express(); //el retorno es un objeto de javascript
...
app.get("/articulo/:articuloId([0-9]+)", function(req, res) { // con .get determino q pasa cuando entro a una ruta agrego
// tantos get como urls (que responde algon) tenga en mi servidor
